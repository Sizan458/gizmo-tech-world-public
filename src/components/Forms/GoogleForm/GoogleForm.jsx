...
const GoogleForm = () => {
    ...
    return (
        ...
        <div className="hero  h-full rounded-lg" style={{backgroundImage: 'url(https://i.ibb.co/k1gnVM1/pexels-craig-dennis-205421.jpg)'}}>
...
<button className="btn btn-outline btn-warning mt-4 mb-3 w-full  md:w-[500px] lg:w-[700px]">Update</button>
</from>
</div>
<div>
